...
| 파일 | 용도 | 라인 수 |
|---|---|---|
| `mcp/server.py` | MCP 서버 (18개 툴) | 480 |
| `mcp/modules/gate0.py` | GATE 0 데이터 검증 | 383 |
| `mcp/modules/hegemonic_fee.py` | 헤게모니 수수료 | 179 |
| `mcp/modules/dual_unit.py` | 듀얼유닛 환산 | 171 |
| `mcp/modules/signal_logger.py` | 시그널 로거 | 224 |
| `mcp/modules/module10_compound_simulator.py` | 복리 시뮬레이터 [v3.3] | 222 |
| `mcp/modules/main.py` | 파이프라인 오케스트레이터 | 206 |
| `docs/FX_ENGINE_TECH_SPEC.md` | 기술 명세서 | 246 |
| `FX_WHITEPAPER_v3.3.md` | 백서 (16장) | — |
| `FX_PHILOSOPHY_100seo.md` | 철학 계보 | 198 |
| **`FX_COMPLETE_v3.3.md`** | **⟪이 문서⟫ 철학→구현 완결** | — |
